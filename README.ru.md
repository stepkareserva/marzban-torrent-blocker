...
```yaml
# Если логи Xray-Core обернуты в JSON, этот тег указывает,
# где в JSON-объекте находится исходная запись лога Xray-Core.
# Пустая строка означает стандартный формат логов Xray-Core.
JsonEntryTag: ""
